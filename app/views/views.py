...
# function for navigation through the dashboard
def dashboard():
    try:
...
@views.route('/profile')
@cross_origin()
# function for navigation through the profile
def profile():
    try:
...
@views.route('/order')
@cross_origin()
# function for navigation to orders page and placement of orders
def order():
    try:
...
#function for navogation to the help page
def help_page():
    try:
